...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {GenerateReference : LocalCoumnGenerateReference,BookingData : LocalCoumnBookingData,OrderData : LocalCoumnOrderData,AddOnArray : LocalCoumnAddOnArray,Category : LocalCoumnCategory,ItemName : LocalCoumnItemName,ItemType : LocalCoumnItemType,Rate : LocalCoumnRate,Pcs : LocalCoumnPcs,Total : LocalCoumnTotal,location : LocalCoumnlocation,DeliveryDateTime : LocalCoumnDeliveryDateTime,ItemService : LocalCoumnItemService};
